#!/usr/bin/env python3
"""
YouTube Researcher -- AUDIO + YOUTUBE SUBS (MULTI-ROTATOR) -- v19
================================================================================

v19 = v18 + VPN_ROTATOR_V6 (fix pkill tất cả tunnel)
      + get_source_address() tự verify IP (v18.1 fix)
      + tunnel dead → force_rotate thay vì next() reconnect
      + import vpn_rotator_v6

v19 FIX:
  - vpn_rotator_v6._disconnect(): khi pid=None → return ngay, KHÔNG pkill
    tất cả openvpn của user. Fix vòng lặp kill lẫn nhau khi chạy
    multi-instance.
  - _disconnect_fallback_pkill() → no-op (không bao giờ gọi nữa).
...
try:
    ...
    from vpn_rotator_v6 import (  # type: ignore
        get_vpn_rotator_from_config,
        VPNRotator,
        is_proxy_dead_error,
    )
...
class IsolatedVPNRotator:
    ...
    def __init__(self, instance_id: str, **vpn_kwargs):
        ...
        import vpn_rotator_v6 as _vr_mod
