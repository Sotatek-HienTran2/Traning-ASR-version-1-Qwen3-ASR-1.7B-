# =============================================================================
# v9: Smart timeout/IP detection — file riêng để refactor từ v7
# =============================================================================
# Copy phần này vào cuối file v7 (youtube_researcher_audio_subs_multi_rotator_v7.py)
# hoặc save thành file riêng rồi import.
#
# Sự khác biệt so với v7:
#   - v7: yt-dlp retries=5 × socket_timeout=30 → 150s TRÊN CÙNG 1 IP trước
